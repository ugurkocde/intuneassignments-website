...
export const env = createEnv({
   ...
   */
  client: {
    NEXT_PUBLIC_AZURE_AD_CLIENT_ID: z.string(),
    NEXT_PUBLIC_AZURE_AD_TENANT_ID: z.string().default("common"),
    NEXT_PUBLIC_AZURE_AD_REDIRECT_URI: z.string().default("http://localhost:3000"),
  },
